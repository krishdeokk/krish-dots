...
StyledRect {
    ...
    readonly property string appIcon: modelData.appName === "Google Chrome" ? "com.google.Chrome" : modelData.appIcon
    readonly property bool hasAppIcon: appIcon.length > 0
    readonly property int bodyTextFormat: Text.StyledText
                ...
                sourceComponent: StyledRect {
                    ...
                    Loader {
                        ...
                        sourceComponent: ColouredIcon {
                            ...
                            layer.enabled: appIcon.endsWith("symbolic")
                        }
                    }
