...
StyledRect {
    ...
    readonly property string image: modelData === "Google Chrome" ? "" : props.img
    readonly property string appIcon: modelData === "Google Chrome" ? "com.google.Chrome" : props.icon
    ...
    RowLayout {
        ...
        Item {
            ...
            Loader {
                ...
                active: root.appIcon && root.image && root.modelData !== "Google Chrome"
