...
StyledRect {
    ...
    readonly property string appIcon: modelData === "Google Chrome" ? "com.google.Chrome" : (activeNotifs.find(n => n.appIcon.length > 0)?.appIcon ?? "")
        ...
        Item {
            ...
            StyledClippingRect {
                ...
                Loader {
                    ...
                    sourceComponent: root.modelData === "Google Chrome" ? appIconComp : root.image ? imageComp : root.appIcon ? appIconComp : materialIconComp
                }
            }
